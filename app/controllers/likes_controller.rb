class LikesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @like.save
        ...
        format.json { redirect_to :back, status: :created, location: @like }
      else
  ...
  def update
    respond_to do |format|
      if @like.update(like_params)
        ...
        format.json { render :back, status: :created, location: @like}
      else
  ...
  private
    ...
    def like_params
      params[:like].permit(:user_id, :liked_id, :liked_type)
    end
end
